...
class PascalVOC(IMDB):
    ...
    """
    classes=['__background__','class_0']
    ...
    def __init__(self, image_set, root_path, devkit_path):
        ...
        self._image_file_tmpl = os.path.join(devkit_path, 'VOC' + year, 'JPEGImages', '{}.jpg')#需修改此处
        print("self._image_file_tmpl=",self._image_file_tmpl)
    ...
    def _parse_voc_anno(filename):
        ...
        for obj in tree.findall('object'):
            ...
            obj_dict['bbox'] = [int(float(bbox.find('x0').text)),
                                int(float(bbox.find('y0').text)),
