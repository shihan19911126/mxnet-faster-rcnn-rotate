...
from symdata.vis import draw_rotate_box_cv#vis_detection#,
...
def parse_args():
    ...
    parser.add_argument('--params', type=str, default='/home/bz/mx-rcnn-master11.2_only_rotate/model/resnet101-0023.params', help='path to trained model')
    parser.add_argument('--dataset', type=str, default='voc', help='training dataset')
    parser.add_argument('--image', type=str, default='/home/bz/mx-rcnn-master11.2_only_rotate/data/VOCdevkit/VOC2007/JPEGImages/13004.jpg', help='path to test image')
    ...
    parser.add_argument('--rpn-anchor-ratios', type=str, default='(0.333,0.5,1,2,3)')
    ...
    parser.add_argument('--rcnn-nms-thresh', type=float, default=0.1)
