...
def train_net(sym, roidb, args):
    ...
    #print ("label_shapes",label_shapes)
    #print ('data_shapr+label_shape=',data_shapes+label_shapes)
...
def parse_args():
    ...
    parser.add_argument('--resume', type=str, default='./model/resnet101-0023.params', help='path to last saved model')  #./model/resnet101-0025.params
    ...
    # faster rcnn params
    #rpn
    parser.add_argument('--img-short-side', type=int, default=800)#800
    ...
    parser.add_argument('--rpn-anchor-scales', type=str, default='(8, 16, 32)')#(4,8, 16, 32)
    parser.add_argument('--rpn-anchor-ratios', type=str, default='(0.333,0.5,1,2,3)')#(1, 0.5, 2, 0.33, 3, 5, 0.25, 4, 0.2, 6, 1.67, 7,1.42)
    ...
    parser.add_argument('--rcnn-bbox-stds', type=str, default='(0.1,0.1,0.2,0.2,0.2)')
